...
Title          :2_2_3_Apply_Correct_Field_Names.py
Description    :Rename fields for ADMN1, ADMN 2 and ADMN 3
...
language = arcpy.GetParameterAsText(7)
...
arcpy.AlterField_management(featureGDB, ad4Mapping, ADM1_LNG, ADM1_LNG)
arcpy.AlterField_management(featureGDB, ad5Mapping, ADM2_LNG, ADM2_LNG)
arcpy.AlterField_management(featureGDB, ad6Mapping, ADM3_LNG, ADM3_LNG)
