...
- apply sql filter to labels on the surrouning country layer to prevent labelling the country you are focusing on
...
- in the location map reset the links for the top two data layers
